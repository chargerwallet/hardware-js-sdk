...
ipcRenderer.on(ipcMessageKeys.INJECT_CHARGERWALLET_DESKTOP_GLOBALS, (_, globals) => {
  // @ts-expect-error
  window.CHARGERWALLET_DESKTOP_GLOBALS = globals;
  // contextBridge.exposeInMainWorld('CHARGERWALLET_DESKTOP_GLOBALS', globals);
});
