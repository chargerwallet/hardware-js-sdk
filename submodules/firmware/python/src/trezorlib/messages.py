...
class EthereumDataTypeChargerWallet(IntEnum):
    UINT = 1
    INT = 2
    BYTES = 3
    STRING = 4
...
class Features(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        508: protobuf.Field("chargerwallet_version", "string", repeated=False, required=False),
        509: protobuf.Field("chargerwallet_serial", "string", repeated=False, required=False),
        ...
        600: protobuf.Field("chargerwallet_device_type", "ChargerWalletDeviceType", repeated=False, required=False),
        601: protobuf.Field("chargerwallet_se_type", "ChargerWalletSeType", repeated=False, required=False),
        602: protobuf.Field("chargerwallet_board_version", "string", repeated=False, required=False),
        603: protobuf.Field("chargerwallet_board_hash", "bytes", repeated=False, required=False),
        604: protobuf.Field("chargerwallet_boot_version", "string", repeated=False, required=False),
        605: protobuf.Field("chargerwallet_boot_hash", "bytes", repeated=False, required=False),
        606: protobuf.Field("chargerwallet_se_version", "string", repeated=False, required=False),
        607: protobuf.Field("chargerwallet_se_hash", "bytes", repeated=False, required=False),
        608: protobuf.Field("chargerwallet_se_build_id", "string", repeated=False, required=False),
        609: protobuf.Field("chargerwallet_firmware_version", "string", repeated=False, required=False),
        610: protobuf.Field("chargerwallet_firmware_hash", "bytes", repeated=False, required=False),
        611: protobuf.Field("chargerwallet_firmware_build_id", "string", repeated=False, required=False),
        612: protobuf.Field("chargerwallet_serial_no", "string", repeated=False, required=False),
        613: protobuf.Field("chargerwallet_boot_build_id", "string", repeated=False, required=False),
        614: protobuf.Field("chargerwallet_ble_name", "string", repeated=False, required=False),
        615: protobuf.Field("chargerwallet_ble_version", "string", repeated=False, required=False),
        616: protobuf.Field("chargerwallet_ble_build_id", "string", repeated=False, required=False),
        617: protobuf.Field("chargerwallet_ble_hash", "bytes", repeated=False, required=False),
    }
    ...
    def __init__(
        ...
        *,
        ...
        chargerwallet_version: Optional["str"] = None,
        chargerwallet_serial: Optional["str"] = None,
        ...
        chargerwallet_device_type: Optional["ChargerWalletDeviceType"] = None,
        chargerwallet_se_type: Optional["ChargerWalletSeType"] = None,
        chargerwallet_board_version: Optional["str"] = None,
        chargerwallet_board_hash: Optional["bytes"] = None,
        chargerwallet_boot_version: Optional["str"] = None,
        chargerwallet_boot_hash: Optional["bytes"] = None,
        chargerwallet_se_version: Optional["str"] = None,
        chargerwallet_se_hash: Optional["bytes"] = None,
        chargerwallet_se_build_id: Optional["str"] = None,
        chargerwallet_firmware_version: Optional["str"] = None,
        chargerwallet_firmware_hash: Optional["bytes"] = None,
        chargerwallet_firmware_build_id: Optional["str"] = None,
        chargerwallet_serial_no: Optional["str"] = None,
        chargerwallet_boot_build_id: Optional["str"] = None,
        chargerwallet_ble_name: Optional["str"] = None,
        chargerwallet_ble_version: Optional["str"] = None,
        chargerwallet_ble_build_id: Optional["str"] = None,
        chargerwallet_ble_hash: Optional["bytes"] = None,
    ) -> None:
        ...
        self.chargerwallet_version = chargerwallet_version
        self.chargerwallet_serial = chargerwallet_serial
        ...
        self.chargerwallet_device_type = chargerwallet_device_type
        self.chargerwallet_se_type = chargerwallet_se_type
        self.chargerwallet_board_version = chargerwallet_board_version
        self.chargerwallet_board_hash = chargerwallet_board_hash
        self.chargerwallet_boot_version = chargerwallet_boot_version
        self.chargerwallet_boot_hash = chargerwallet_boot_hash
        self.chargerwallet_se_version = chargerwallet_se_version
        self.chargerwallet_se_hash = chargerwallet_se_hash
        self.chargerwallet_se_build_id = chargerwallet_se_build_id
        self.chargerwallet_firmware_version = chargerwallet_firmware_version
        self.chargerwallet_firmware_hash = chargerwallet_firmware_hash
        self.chargerwallet_firmware_build_id = chargerwallet_firmware_build_id
        self.chargerwallet_serial_no = chargerwallet_serial_no
        self.chargerwallet_boot_build_id = chargerwallet_boot_build_id
        self.chargerwallet_ble_name = chargerwallet_ble_name
        self.chargerwallet_ble_version = chargerwallet_ble_version
        self.chargerwallet_ble_build_id = chargerwallet_ble_build_id
        self.chargerwallet_ble_hash = chargerwallet_ble_hash
...
class EthereumSignTypedDataChargerWallet(protobuf.MessageType):
...
class EthereumTypedDataStructRequestChargerWallet(protobuf.MessageType):
...
class EthereumTypedDataStructAckChargerWallet(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = 20113
    FIELDS = {
        1: protobuf.Field("members", "EthereumStructMemberChargerWallet", repeated=True, required=False),
    }

    def __init__(
        self,
        *,
        members: Optional[Sequence["EthereumStructMemberChargerWallet"]] = None,
    ) -> None:
        self.members: Sequence["EthereumStructMemberChargerWallet"] = members if members is not None else []


class EthereumTypedDataValueRequestChargerWallet(protobuf.MessageType):
...
class EthereumTypedDataValueAckChargerWallet(protobuf.MessageType):
...
class EthereumStructMemberChargerWallet(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = None
    FIELDS = {
        1: protobuf.Field("type", "EthereumFieldTypeChargerWallet", repeated=False, required=True),
...
class EthereumFieldTypeChargerWallet(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = None
    FIELDS = {
        1: protobuf.Field("data_type", "EthereumDataTypeChargerWallet", repeated=False, required=True),
        2: protobuf.Field("size", "uint32", repeated=False, required=False),
        3: protobuf.Field("entry_type", "EthereumFieldTypeChargerWallet", repeated=False, required=False),
    ...
    def __init__(
        ...
        *,
        ...
        entry_type: Optional["EthereumFieldTypeChargerWallet"] = None,
...
class EthereumGetPublicKeyChargerWallet(protobuf.MessageType):
...
class EthereumPublicKeyChargerWallet(protobuf.MessageType):
...
class EthereumGetAddressChargerWallet(protobuf.MessageType):
...
class EthereumAddressChargerWallet(protobuf.MessageType):
...
class EthereumSignTxChargerWallet(protobuf.MessageType):
...
class EthereumSignTxEIP1559ChargerWallet(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        11: protobuf.Field("access_list", "EthereumAccessListChargerWallet", repeated=True, required=False),
    }
    ...
    def __init__(
        ...
        *,
        ...
        chain_id: "int",
        address_n: Optional[Sequence["int"]] = None,
        access_list: Optional[Sequence["EthereumAccessListChargerWallet"]] = None,
        to: Optional["str"] = '',
        data_initial_chunk: Optional["bytes"] = b'',
    ) -> None:
        self.address_n: Sequence["int"] = address_n if address_n is not None else []
        self.access_list: Sequence["EthereumAccessListChargerWallet"] = access_list if access_list is not None else []
        self.nonce = nonce
...
class EthereumTxRequestChargerWallet(protobuf.MessageType):
...
class EthereumTxAckChargerWallet(protobuf.MessageType):
...
class EthereumSignMessageChargerWallet(protobuf.MessageType):
...
class EthereumMessageSignatureChargerWallet(protobuf.MessageType):
...
class EthereumVerifyMessageChargerWallet(protobuf.MessageType):
...
class EthereumSignTypedHashChargerWallet(protobuf.MessageType):
...
class EthereumTypedDataSignatureChargerWallet(protobuf.MessageType):
...
class EthereumAccessListChargerWallet(protobuf.MessageType):
    MESSAGE_WIRE_TYPE = None
    FIELDS = {
        1: protobuf.Field("address", "string", repeated=False, required=True),
