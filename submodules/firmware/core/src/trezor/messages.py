...
if TYPE_CHECKING:
    ...
    from trezor.enums import CommandFlags  # noqa: F401
    ...
    from trezor.enums import ChargerWalletDeviceType  # noqa: F401
    from trezor.enums import ChargerWalletSeType  # noqa: F401
    ...
    class BixinPinInputOnDevice(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["BixinPinInputOnDevice"]:
            return isinstance(msg, cls)
    ...
    class GetPublicKeyMultiple(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["GetPublicKeyMultiple"]:
            return isinstance(msg, cls)
    ...
    class PublicKeyMultiple(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["PublicKeyMultiple"]:
            return isinstance(msg, cls)
    ...
    class BIP32Address(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["BIP32Address"]:
            return isinstance(msg, cls)
    ...
    class CardanoGovernanceRegistrationDelegation(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["CardanoGovernanceRegistrationDelegation"]:
            return isinstance(msg, cls)
    ...
    class CardanoGovernanceRegistrationParametersType(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["CardanoGovernanceRegistrationParametersType"]:
            return isinstance(msg, cls)
    ...
    class CardanoSignMessage(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["CardanoSignMessage"]:
            return isinstance(msg, cls)
    ...
    class CardanoMessageSignature(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["CardanoMessageSignature"]:
            return isinstance(msg, cls)
    ...
    class Features(protobuf.MessageType):
        ...
        chargerwallet_version: "str | None"
        chargerwallet_serial: "str | None"
        ...
        chargerwallet_device_type: "ChargerWalletDeviceType | None"
        chargerwallet_se_type: "ChargerWalletSeType | None"
        chargerwallet_board_version: "str | None"
        chargerwallet_board_hash: "bytes | None"
        chargerwallet_boot_version: "str | None"
        chargerwallet_boot_hash: "bytes | None"
        chargerwallet_se_version: "str | None"
        chargerwallet_se_hash: "bytes | None"
        chargerwallet_se_build_id: "str | None"
        chargerwallet_firmware_version: "str | None"
        chargerwallet_firmware_hash: "bytes | None"
        chargerwallet_firmware_build_id: "str | None"
        chargerwallet_serial_no: "str | None"
        chargerwallet_boot_build_id: "str | None"
        chargerwallet_ble_name: "str | None"
        chargerwallet_ble_version: "str | None"
        chargerwallet_ble_build_id: "str | None"
        chargerwallet_ble_hash: "bytes | None"
        ...
        def __init__(
            ...
            *,
            ...
            chargerwallet_version: "str | None" = None,
            chargerwallet_serial: "str | None" = None,
            ...
            chargerwallet_device_type: "ChargerWalletDeviceType | None" = None,
            chargerwallet_se_type: "ChargerWalletSeType | None" = None,
            chargerwallet_board_version: "str | None" = None,
            chargerwallet_board_hash: "bytes | None" = None,
            chargerwallet_boot_version: "str | None" = None,
            chargerwallet_boot_hash: "bytes | None" = None,
            chargerwallet_se_version: "str | None" = None,
            chargerwallet_se_hash: "bytes | None" = None,
            chargerwallet_se_build_id: "str | None" = None,
            chargerwallet_firmware_version: "str | None" = None,
            chargerwallet_firmware_hash: "bytes | None" = None,
            chargerwallet_firmware_build_id: "str | None" = None,
            chargerwallet_serial_no: "str | None" = None,
            chargerwallet_boot_build_id: "str | None" = None,
            chargerwallet_ble_name: "str | None" = None,
            chargerwallet_ble_version: "str | None" = None,
            chargerwallet_ble_build_id: "str | None" = None,
            chargerwallet_ble_hash: "bytes | None" = None,
        ) -> None:
            pass
    ...
    class BixinMessageSE(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["BixinMessageSE"]:
            return isinstance(msg, cls)
    ...
    class BixinVerifyDeviceRequest(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["BixinVerifyDeviceRequest"]:
            return isinstance(msg, cls)
    ...
    class BixinLoadDevice(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["BixinLoadDevice"]:
            return isinstance(msg, cls)

    class BixinBackupDevice(protobuf.MessageType):

        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["BixinBackupDevice"]:
            return isinstance(msg, cls)
    ...
    class BixinBackupDeviceAck(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["BixinBackupDeviceAck"]:
            return isinstance(msg, cls)
    ...
    class SpiFlashWrite(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["SpiFlashWrite"]:
            return isinstance(msg, cls)
    ...
    class SpiFlashRead(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["SpiFlashRead"]:
            return isinstance(msg, cls)
    ...
    class SpiFlashData(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["SpiFlashData"]:
            return isinstance(msg, cls)
    ...
    class NFTWriteInfo(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["NFTWriteInfo"]:
            return isinstance(msg, cls)
    ...
    class NFTWriteData(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["NFTWriteData"]:
            return isinstance(msg, cls)
    ...
    class TronWithdrawBalanceContract(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["TronWithdrawBalanceContract"]:
            return isinstance(msg, cls)
    ...
    class TronFreezeBalanceV2Contract(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["TronFreezeBalanceV2Contract"]:
            return isinstance(msg, cls)
    ...
    class TronUnfreezeBalanceV2Contract(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["TronUnfreezeBalanceV2Contract"]:
            return isinstance(msg, cls)

    class TronWithdrawExpireUnfreezeContract(protobuf.MessageType):

        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["TronWithdrawExpireUnfreezeContract"]:
            return isinstance(msg, cls)
    ...
    class TronDelegateResourceContract(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["TronDelegateResourceContract"]:
            return isinstance(msg, cls)
    ...
    class TronUnDelegateResourceContract(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["TronUnDelegateResourceContract"]:
            return isinstance(msg, cls)
    ...
    class ConfluxGetAddress(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["ConfluxGetAddress"]:
            return isinstance(msg, cls)
    ...
    class ConfluxAddress(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["ConfluxAddress"]:
            return isinstance(msg, cls)
    ...
    class ConfluxSignTx(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["ConfluxSignTx"]:
            return isinstance(msg, cls)
    ...
    class ConfluxTxRequest(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["ConfluxTxRequest"]:
            return isinstance(msg, cls)
    ...
    class ConfluxTxAck(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["ConfluxTxAck"]:
            return isinstance(msg, cls)
    ...
    class ConfluxSignMessage(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: protobuf.MessageType) -> TypeGuard["ConfluxSignMessage"]:
            return isinstance(msg, cls)
