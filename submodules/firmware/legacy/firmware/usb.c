...
#define USB_STRINGS                                 \
  ...
  X(PRODUCT, "CHARGERWALLET")                              \
  X(SERIAL_NUMBER, config_uuid_str)                 \
  X(INTERFACE_MAIN, "CHARGERWALLET Interface")             \
  X(INTERFACE_DEBUG, "CHARGERWALLET Debug Link Interface") \
  X(INTERFACE_U2F, "CHARGERWALLET U2F Interface")
...
void usbInit(void) {
  ...
  static const char *origin_url = "chargerwallet.com";
