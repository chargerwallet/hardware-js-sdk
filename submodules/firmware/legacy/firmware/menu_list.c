  ...
  switch (page) {
    ...
    case 1:
      ...
      oledDrawStringCenterAdapter(OLED_WIDTH / 2, 3 * 10,
                                  _("Download ChargerWallet Apps"), FONT_STANDARD);
      oledDrawStringCenterAdapter(OLED_WIDTH / 2, 6 * 10, "chargerwallet.com/download",
                                  FONT_STANDARD);
      oledBox(23, 70, 108, 70, true);
#else
      oledDrawStringCenterAdapter(OLED_WIDTH / 2, 2 * 10, _("Download ChargerWallet"),
                                  FONT_STANDARD);
      oledDrawStringCenterAdapter(OLED_WIDTH / 2, 3 * 10, "chargerwallet.com/download",
                                  FONT_STANDARD);
#endif
      oledDrawBitmap(60, OLED_HEIGHT - 8, &bmp_btn_down);
      break;
    ...
    case 2:
      ...
      oledDrawStringCenterAdapterEx(
          ...
          FONT_STANDARD);
      oledDrawStringCenterAdapter(OLED_WIDTH / 2, 7 * 10, "help.chargerwallet.com",
                                  FONT_STANDARD);
    ...
    case 4:
      layoutQRCode(index_str, &bmp_btn_up, NULL, NULL,
                   "https://chargerwallet.zendesk.com/hc/zh-cn/articles/360002123856");
      break;
  }
#if !CHARGERWALLET_MINI
