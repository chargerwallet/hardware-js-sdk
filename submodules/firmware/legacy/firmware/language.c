...
//
    ...
    //
    {"Check this device with\nChargerWallet secure server?",
     "确定访问ChargerWallet服务器对\n此设备进行防伪校验吗?"},
    {"Choose the correct\nwords based on the\nrecovery phrase\nyou've put "
     "down.",
     "接下来,请根据已写下的助\n记词选择正确的单词"},
    ...
    //
    {"Done", "完成"},
    {"Download ChargerWallet", "下载ChargerWallet"},
    // menu_list.c
    {"Download ChargerWallet Apps", "官网下载ChargerWallet客户端"},
    //
...
//
    ...
    {"Visiting Help Center and search \"Blind Signing\" to "
     "learn more\n help.chargerwallet.com",
     "访问help.chargerwallet.so搜索盲签了解更多"},
#endif
    {"WARNING: The device\nwill be reset after\n10 wrong attempts",
     "注意: 若累计输错10次\n设备将自动重置"},
    // config.c
