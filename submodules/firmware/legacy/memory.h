...
#define SPI_FLASH_FIRMWARE_ADDR_START 0x700000
#define SPI_FLASH_FIRMWARE_ADDR_END 0x800000
#define SPI_FLASH_FIRMWARE_BLOCKS                                  \
  ((SPI_FLASH_FIRMWARE_ADDR_END - SPI_FLASH_FIRMWARE_ADDR_START) / \
   SPI_FLASH_BLOCK_SIZE)

#define SPI_FLASH_NFT_HEADER_ADDR_START 0x400000
#define SPI_FLASH_NFT_HEADER_LEN (8 * 1024)
#define SPI_FLASH_NFT_HEADER_ADDR_END \
  (SPI_FLASH_NFT_HEADER_ADDR_START + SPI_FLASH_NFT_HEADER_LEN)

#define SPI_FLASH_NFT_DATA_ADDR_START 0x402000
...
#define FLASH_BLE_ADDR_START (0x080E0000)
...
#define FLASH_BLE_MAX_LEN (0x20000)
